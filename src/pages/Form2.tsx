...
const Form2 = () => {
  return (
    <>
      <Helmet>
        <title>Individual Service Plan Form - The Worx</title>
        <meta name="description" content="Individual Service Plan Form - Create and manage recovery peer-based individualized service plans." />
      </Helmet>
